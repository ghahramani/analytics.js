(function (f) {
    ...
    return (function e(t, n, r) {
        ...
        1: [
            ...
            {"../package.json": 106, "./integrations": 2, "@segment/analytics.js-core": 23}
        ], 2: [
            function (require, module, exports) {
            ...
            {"@ghahramani/analytics.js-integration-infoowl": 3}
        ], 3: [
            function (require, module, exports) {
                'use strict';
            ...
            },
            {
                ...
                "@segment/analytics.js-integration": 33,
                "@segment/protocol": 44,
                "@segment/send-json": 45,
                "@segment/top-domain": 47,
                "@segment/utm-params": 48,
                "component-clone": 52,
                "component-cookie": 53,
                "json3": 70,
                "spark-md5": 93,
...
// TODO: Move to a library
                ...
                var defaultsDeep = function defaultsDeep(target /*, sources */) {
                    ...
                    return defaultsWith.apply(null, [
                        deepCombiner,
                        target
            ...
            {"@ndhoule/drop": 8, "@ndhoule/rest": 17}
        ], 8: [
            function (require, module, exports) {
                'use strict';
...
// TODO: Move to lib
            ...
            {"./entity": 21, "bind-all": 50, "debug": 29, "inherits": 67}
        ], 23: [
            function (require, module, exports) {
                'use strict';
...
// Expose package version.
            ...
            {"@ndhoule/includes": 13, "@segment/canonical": 37, "component-url": 62}
        ], 27: [
            function (require, module, exports) {
                'use strict';
            ...
            {"@ndhoule/defaults": 7, "@segment/store": 46, "bind-all": 50}
        ], 28: [
            function (require, module, exports) {
                'use strict';
 ...
 *  };
            ...
            {"@ndhoule/each": 9, "@ndhoule/includes": 13, "component-emitter": 56, "domify": 65}
        ], 36: [
            function (require, module, exports) {
...
// Formatters
            ...
            {"@segment/isodate": 41, "component-each": 54, "component-type": 61}
        ], 41: [
            function (require, module, exports) {
                'use strict';
            ...
            {"component-type": 61, "next-tick": 77, "script-onload": 80}
        ], 43: [
            function (require, module, exports) {
                'use strict';
 ...
 * };
            ...
            {"@segment/base64-encode": 36, "has-cors": 66, "json3": 70, "jsonp": 71}
        ], 46: [
            function (require, module, exports) {
                (function (global) {
                    "use strict";;;
            ...
            {"component-cookie": 53, "component-url": 62}
        ], 48: [
            function (require, module, exports) {
                'use strict';
            ...
            {"@ndhoule/foldl": 12, "component-querystring": 59}
        ], 49: [
            function (require, module, exports) {
                'use strict';
 ...
 *  }] => /
            ...
            {"@ndhoule/foldl": 12, "@ndhoule/map": 15}
        ], 50: [
            function (require, module, exports) {
                'use strict';
            ...
            {"component-type": 55, "to-function": 94, "type": 55}
        ], 55: [
            function (require, module, exports) {
...
// code borrowed from https://github.com/feross/is-buffer/blob/master/index.js
            ...
            {"is": 69, "next-tick": 77, "script-onload": 80}
        ], 73: [
            function (require, module, exports) {
                /**
                 * Helpers.
            ...
            {"./milliseconds": 75, "./seconds": 76, "@segment/isodate": 41, "is": 69}
        ], 75: [
            function (require, module, exports) {
                'use strict';
...
// https://github.com/thirdpartyjs/thirdpartyjs-code/blob/master/examples/templates/02/loading-files/index.html
            ...
            {"./facade": 83, "./utils": 91, "is-email": 68, "new-date": 74}
        ], 85: [
            function (require, module, exports) {
                'use strict';
            ...
            {"./facade": 83, "./utils": 91, "is-email": 68, "new-date": 74, "obj-case": 78, "trim": 96}
        ], 86: [
            function (require, module, exports) {
                'use strict';
            ...
            {"./facade": 83, "./track": 90, "./utils": 91, "is-email": 68}
        ], 89: [
            function (require, module, exports) {
                'use strict';
            ...
            {"./facade": 83, "./identify": 85, "./utils": 91, "is-email": 68, "obj-case": 78}
        ], 91: [
            function (require, module, exports) {
                'use strict';
            ...
            {"@ndhoule/clone": 6, "inherits": 67, "type-component": 97}
        ], 92: [
            function (require, module, exports) {
...
// See https://github.com/broofa/node-uuid for API details
            ...
            {"./lib/bytesToUuid": 100, "./lib/rng": 101}
        ], 103: [
            function (require, module, exports) {
                var rng = require('./lib/rng');
                var bytesToUuid = require('./lib/bytesToUuid');
